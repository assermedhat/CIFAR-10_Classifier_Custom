...
class Main(Orchestrator):
    def __init__(self,writer,train_dataloader,test_dataloader,model,lr=0.001,l2_reg=0.0,retrain=False,checkpoint="resnet_cifar10.pth"):
        Orchestrator.__init__(self,writer,train_dataloader,test_dataloader,model=model,lr=lr,l2_reg=l2_reg,retrain=retrain,checkpoint_path=checkpoint)
...
if __name__ == "__main__":
    ...
    main=Main(writer,train_data,test_data,model=model,lr=0.0001,retrain=True,l2_reg=0.0005)
    main.fit(epochs=10)
